...
<main class="draw-main">
    ...
    <section class="draw-tools">
        <button onclick="setTool('pencil')" class="tool-btn active" title="Pencil"><i class="fas fa-pencil-alt"></i></button>
        <button onclick="setTool('bucket')" class="tool-btn" title="Flood Fill"><i class="fas fa-fill-drip"></i></button>
        <button onclick="setTool('color')" class="tool-btn" title="Change Color"><i class="fas fa-tint"></i></button>
        ...
        <button onclick="exportAscii()" class="tool-btn" title="Export ASCII"><i class="fas fa-file-export"></i></button>
