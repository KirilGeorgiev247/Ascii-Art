...
function saveDrawing() {
  ...
  showDialog("Enter a title for your drawing:", "question", {
    input: true,
    inputType: "text",
...
function downloadAscii() {
  ...
  showDialog("Enter a file name for your ASCII art:", "question", {
    input: true,
    inputType: "text",
    ...
    onOk: function (filename) {
      filename =
        filename && filename.trim() ? filename.trim() : "ascii-art.txt";
